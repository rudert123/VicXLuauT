...
var LuaHighlightRules = function() {
    ...
    var functions = (
        ...
        // Env Library
        "gethui|lz4compress|lz4decompress|getidentity|getthreadidentity|"+
        "getthreadcontext|setidentity|setthreadidentity|setthreadcontext|"+
        "isluau|identifyexecutor|cloneref|getcustomasset|getcallbackvalue|"+
        "toclipboard|setrbxclipboard|setclipboard|isrbxactive|isgameactive|"+
        "checkcaller|getgc|getinstancelist|getnilinstances|getinstances|"+
        "getloadedmodules|getrunningscripts|compareinstances|getgenv|getreg|getrenv|loadstring|"+
        
        //  Closure Library
        "hookfunction|newcclosure|iscclosure|islclosure|isnewcclosure|"+
        "isexecutorclosure|clonefunction|restorefunction|"+

        // Debug Library
        "getconstant|getconstants|getinfo|getproto|getprotos|"+
        "getstack|getupvalue|getupvalues|setconstant|setstack|"+
        "setproto|setupvalue|getregistry|"+

        // File Library + Http
        "makefolder|readfile|writefile|listfiles|isfolder|isfile|"+
        "delfolder|delfile|loadfile|appendfile|request|"+
        ...
        // Metatable Library
        "getnamecallmethod|setnamecallmethod|setreadonly|"+
        "makereadonly|makewriteable|isreadonly|getrawmetatable|"+
        "setrawmetatable|hookmetamethod|"+

        // Script Library
        "decompile|getscripthash|getscriptclosure|getcallingscript|sethiddenproperty|getconnections"
    );
